<template>
  ...
  <div class="row">
    ...
    <span  style="font-size:15px " v-if="settings.gst_number">GST NO: {{settings.gst_number}}</span><br v-if="settings.gst_number">
      <span  style="font-size:18px ">
        <span v-if="sale.type=='d'">DINE-IN</span>
        <span v-else-if="sale.type=='t'">TAKEAWAY</span>
        <span v-else-if="sale.type=='s'">DELIVERY</span>
        <span v-else-if="sale.type=='b'">BOOKING</span>
      </span><br>
...
<div class="row" style="line-height:18px">
  <div class="col 12">
  <span v-if="$route.params.return">Return </span>KOT<br> Bill No: {{sale.id}}  <br>
